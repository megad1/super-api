...
var PIX_PRODUCTS = {
  ...
  // ── DOWNSELL (50% OFF) ──
  seguro_ds: { price: 10.82, name: "Downsell Front - Seguro Prestamista - SuperSim" },
  up1_ds:  { price: 12.41, name: "Downsell UP1 - IOF - Imposto sobre Operações Financeiras" },
  up2_ds:  { price: 11.96, name: "Downsell UP2 - Taxa de Verificação de IOF" },
  up3_ds:  { price: 9.34,  name: "Downsell UP3 - Seguro Prestamista - Tarifa de Cadastro" },
  up4_ds:  { price: 8.60,  name: "Downsell UP4 - TENF - Taxa de Emissão da Nota Fiscal" },
  up5_ds:  { price: 8.50,  name: "Downsell UP5 - Ativar Conta" },
  up6_ds:  { price: 8.50,  name: "Downsell UP6 - Taxa de Registro do Contrato" },
  up7_ds:  { price: 7.03,  name: "Downsell UP7 - Taxa - Limite Adicional de R$20.000" },
  up8_ds:  { price: 7.03,  name: "Downsell UP8 - Taxa de Processamento" },
  up9_ds:  { price: 6.00,  name: "Downsell UP9 - Aplicativo SuperSim" },
  up10_ds: { price: 8.46,  name: "Downsell UP10 - TAC - Taxa de Abertura de Crédito" },
  up11_ds: { price: 9.77,  name: "Downsell UP11 - Taxa de Consultoria Financeira" },
  up12_ds: { price: 15.96, name: "Downsell UP12 - Taxa de Processamento Administrativo" },
};
